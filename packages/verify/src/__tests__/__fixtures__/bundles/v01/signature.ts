...
// The TLog entry is kind=dsse, but this bundle is not a DSSE bundle.
const invalidDSSETLogEntryForMessageSig = {
  mediaType: 'application/vnd.dev.sigstore.bundle+json;version=0.1',
  verificationMaterial: {
    x509CertificateChain: {
      certificates: [
...
// The TLog entry is kind=intoto, but this bundle is not a DSSE bundle.
const invalidIntotoTLogEntryForMessageSig = {
  mediaType: 'application/vnd.dev.sigstore.bundle+json;version=0.1',
  verificationMaterial: {
    x509CertificateChain: {
      certificates: [
...
export default {
  ...
  invalid: {
    ...
    duplicateTLog: invalidDuplicateTLog,
